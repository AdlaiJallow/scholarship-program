...
class AuditLog(UUIDPrimaryKeyModel):
    ...
    class Action(models.TextChoices):
        ...
        IDENTITY_VERIFICATION_FAILED = "activation.identity_verification_failed", "Activation identity verification failed"
        ACTIVATION_DUPLICATE_BLOCKED = "activation.duplicate_blocked", "Duplicate activation attempt blocked"
        VERIFICATION_CODE_SENT = "activation.code_sent", "Verification code sent"
        VERIFICATION_CODE_RESENT = "activation.code_resent", "Verification code resent"
        VERIFICATION_CODE_VERIFIED = "activation.code_verified", "Verification code verified"
        VERIFICATION_CODE_FAILED = "activation.code_failed", "Verification code attempt failed"
